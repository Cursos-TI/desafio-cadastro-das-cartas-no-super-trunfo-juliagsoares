...
int main() {
    ...
    // Lógica para cálculo do Super Poder.
    super_poder_carta1 = (float) (populacao_carta1 + area_carta1 + pib_carta1 + pontos_turisticos_carta1 + pib_per_capita_carta1 + (1 / densidade_populacional_carta1));
    ...
    // Lógica para cálculo do Super Poder.
    super_poder_carta2 = (float) (populacao_carta2 + area_carta2 + pib_carta2 + pontos_turisticos_carta2 + pib_per_capita_carta2 + (1 / densidade_populacional_carta2));
    ...
    // Fazendo comparação entre as cartas.

    char resultado_populacao[20], resultado_area[20], resultado_pib[20], resultado_pontos_turisticos[20], resultado_pib_per_capita[20], resultado_densidade[20], resultado_super_poder[20];
